...
def stochastic_reachability_graph_visualize(ts, parameters=None):
    ...
    # if force_names:
    #     new_ts = copy(ts)
    #     for index, state in enumerate(new_ts.states):
...
def visualize_slpn(net, trans2weight, initial_marking=None, final_marking=None, image_format="png", decorations=None, debug=False, set_rankdir=None, font_size="12", bgcolor=constants.DEFAULT_BGCOLOR):
    """
